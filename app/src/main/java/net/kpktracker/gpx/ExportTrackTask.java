...
public abstract class ExportTrackTask extends AsyncTask<Void, Long, Boolean> {
	...
	protected void exportTrackAsGpx(long trackId) throws ExportTrackException {
		...
		if (ContextCompat.checkSelfPermission(context,
			...
			if (sdRoot.canWrite()) {
				...
				String track_vehicle_type = c.getString(c.getColumnIndex(TrackContentProvider.Schema.COL_ROUTE_TYPE));
				...
				if (null != cTrackPoints && null != cWayPoints) {
					...
					try {
						writeGpxFile(track_name, track_surveyor, track_project, track_route_name, track_route_id,
								track_headway_mns, track_vehicle_type, track_fare_price, tags, track_description,
	...
	private void writeGpxFile(String trackName, String track_surveyor, String track_project, String track_route_name, String track_route_id,
							  String track_headway_mns, String track_vehicle_type, String track_fare_price,
		...
		try {
			...
			if ((track_vehicle_type != null && !track_vehicle_type.equals(""))) {
				writer.write("\t\t<vehicle_type>"+ track_vehicle_type +"</vehicle_type>\n");
			}
