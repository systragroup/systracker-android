...
public class TrackContentProvider extends ContentProvider {
	...
	private static final String[] TRACK_TABLES_PROJECTION = {
		...
		Schema.COL_TAGS,
		Schema.TBL_TRACK + "." + Schema.COL_SURVEYOR + " as "+ Schema.COL_SURVEYOR,
		Schema.TBL_TRACK + "." + Schema.COL_ROUTE_NAME + " as "+ Schema.COL_ROUTE_NAME,
		Schema.TBL_TRACK + "." + Schema.COL_ROUTE_ID + " as "+ Schema.COL_ROUTE_ID,
		Schema.TBL_TRACK + "." + Schema.COL_HEADWAY_MINUTES + " as "+ Schema.COL_HEADWAY_MINUTES,
		Schema.TBL_TRACK + "." + Schema.COL_ROUTE_TYPE + " as "+ Schema.COL_ROUTE_TYPE,
		Schema.TBL_TRACK + "." + Schema.COL_FARE_PRICE + " as "+ Schema.COL_FARE_PRICE,
		Schema.TBL_TRACK + "." + Schema.COL_NB_PASSENGERS + " as "+ Schema.COL_NB_PASSENGERS,
		Schema.TBL_TRACK + "." + Schema.COL_PROJECT + " as "+ Schema.COL_PROJECT,
	...
	public static final class Schema {
		...
		public static final String COL_SURVEYOR = "surveyor";
		public static final String COL_ROUTE_NAME = "route_name";
		public static final String COL_ROUTE_ID = "route_id";
		public static final String COL_HEADWAY_MINUTES = "headway_mns";
		public static final String COL_ROUTE_TYPE = "route_type";
		public static final String COL_FARE_PRICE = "fare_price";
		public static final String COL_NB_PASSENGERS = "nb_passengers";
