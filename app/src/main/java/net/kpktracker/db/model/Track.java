package net.kpktracker.db.model;
...
public class Track {
	...
	public enum VehicleType {
		Bus(0, R.string.trackdetail_vehicle_type_bus),
		Minibus(1, R.string.trackdetail_vehicle_type_minibus),
		Suzukis(2, R.string.trackdetail_vehicle_type_suzukis),
		Rickshaw(3, R.string.trackdetail_vehicle_type_rickshaw);

		public final int position;
		public final int resId;

		private VehicleType(int position, int resId) {
			this.position = position;
			this.resId = resId;
		}

		public static VehicleType fromPosition(int position) {
	...
	public static Track build(final long trackId, Cursor tc, ContentResolver cr, boolean withExtraInformation) {
		...
		out.surveyor = tc.getString(tc.getColumnIndex(TrackContentProvider.Schema.COL_SURVEYOR));
		out.routeName = tc.getString(tc.getColumnIndex(TrackContentProvider.Schema.COL_ROUTE_NAME));
		out.routeID = tc.getString(tc.getColumnIndex(TrackContentProvider.Schema.COL_ROUTE_ID));
		out.headwayMns = tc.getString(tc.getColumnIndex(TrackContentProvider.Schema.COL_HEADWAY_MINUTES));
		try {
			out.vehicleType = VehicleType.valueOf(tc.getString(tc.getColumnIndex(TrackContentProvider.Schema.COL_ROUTE_TYPE)));
		} catch (Exception ex) {
			out.vehicleType = VehicleType.valueOf("Bus");
		}
		out.farePrice = tc.getString(tc.getColumnIndex(TrackContentProvider.Schema.COL_FARE_PRICE));
		out.nbPassengers = tc.getInt(tc.getColumnIndex(TrackContentProvider.Schema.COL_NB_PASSENGERS));
		out.project = tc.getString(tc.getColumnIndex(TrackContentProvider.Schema.COL_PROJECT));
	...
	public void setSurveyor(String value) { this.surveyor = value; }
	public String getSurveyor() { return this.surveyor;	}
	public void setRouteName(String value) { this.routeName = value; }
	...
	public void setHeadwayMns(String value) { this.headwayMns = value; }
	public String getHeadwayMns() { return this.headwayMns;	}
	...
	public void setFarePrice(String value) { this.farePrice = value; }
	public String getFarePrice() { return this.farePrice;	}
	public void setNbPassengers(int value) { this.nbPassengers = value; }
	public int getNbPassengers() { return this.nbPassengers;	}
