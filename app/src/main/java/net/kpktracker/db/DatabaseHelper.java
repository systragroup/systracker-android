...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String SQL_CREATE_TABLE_TRACK = ""
		...
		+ TrackContentProvider.Schema.COL_SURVEYOR + " text,"
		+ TrackContentProvider.Schema.COL_ROUTE_NAME + " text,"
		+ TrackContentProvider.Schema.COL_ROUTE_ID + " text,"
		+ TrackContentProvider.Schema.COL_HEADWAY_MINUTES + " text,"
		+ TrackContentProvider.Schema.COL_ROUTE_TYPE + " text,"
		+ TrackContentProvider.Schema.COL_FARE_PRICE + " text,"
		+ TrackContentProvider.Schema.COL_NB_PASSENGERS + " integer not null default 0,"
		+ TrackContentProvider.Schema.COL_PROJECT + " text,"
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		case 18:
			db.execSQL("alter table " + TrackContentProvider.Schema.TBL_TRACK + " add column " + TrackContentProvider.Schema.COL_SURVEYOR + " text");
			db.execSQL("alter table " + TrackContentProvider.Schema.TBL_TRACK + " add column " + TrackContentProvider.Schema.COL_ROUTE_NAME + " text");
			db.execSQL("alter table " + TrackContentProvider.Schema.TBL_TRACK + " add column " + TrackContentProvider.Schema.COL_ROUTE_ID + " text");
			db.execSQL("alter table " + TrackContentProvider.Schema.TBL_TRACK + " add column " + TrackContentProvider.Schema.COL_HEADWAY_MINUTES + " text");
			db.execSQL("alter table " + TrackContentProvider.Schema.TBL_TRACK + " add column " + TrackContentProvider.Schema.COL_ROUTE_TYPE + " text");
			db.execSQL("alter table " + TrackContentProvider.Schema.TBL_TRACK + " add column " + TrackContentProvider.Schema.COL_FARE_PRICE + " text");
			db.execSQL("alter table " + TrackContentProvider.Schema.TBL_TRACK + " add column " + TrackContentProvider.Schema.COL_PROJECT + " text");
			db.execSQL("alter table " + TrackContentProvider.Schema.TBL_TRACK + " add column " + TrackContentProvider.Schema.COL_NB_PASSENGERS + " integer not null default 0");
		}
	}
