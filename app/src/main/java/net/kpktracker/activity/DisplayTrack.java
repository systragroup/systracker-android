...
import net.kpktracker.view.DisplayTrackView;
			...
			dtv.post(new Runnable() {
				...
				public void run() {
					new AlertDialog.Builder(DisplayTrack.this)
						.setTitle(net.kpktracker.R.string.prefs_displaytrack_osm)
						.setMessage(net.kpktracker.R.string.prefs_displaytrack_osm_summary_ask)
						.setNegativeButton(android.R.string.no, null)
						.setPositiveButton(net.kpktracker.R.string.displaytrack_map, new DialogInterface.OnClickListener() {
							@Override
