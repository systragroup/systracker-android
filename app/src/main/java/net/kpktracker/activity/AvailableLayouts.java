...
import net.kpktracker.layout.DownloadCustomLayoutTask;
import net.kpktracker.layout.GetStringResponseTask;
import net.kpktracker.layout.URLValidatorTask;
import net.kpktracker.util.CustomLayoutsUtils;
import net.kpktracker.util.URLCreator;
...
public class AvailableLayouts extends Activity {
    ...
    private final static String TMP_SHARED_PREFERENCES_FILE = "net.kpktracker.tmpspfile";
