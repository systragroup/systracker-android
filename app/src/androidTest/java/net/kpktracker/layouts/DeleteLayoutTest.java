package net.kpktracker.layouts;
...
import net.kpktracker.activity.ButtonsPresets;
import net.kpktracker.activity.Preferences;
...
import static net.kpktracker.util.TestUtils.checkToastIsShownWith;
import static net.kpktracker.util.TestUtils.getLayoutsDirectory;
import static net.kpktracker.util.TestUtils.getStringResource;
import static net.kpktracker.util.TestUtils.injectMockLayout;
import static net.kpktracker.util.TestUtils.listFiles;
